...
from shop.homepage.models import Category, Brand, Product
from shop.homepage.routes import brands, categories
import json
...
def getCart():
    if 'Shoppingcart' not in session or len(session['Shoppingcart']) <= 0:
        return render_template('homepage/carts.html', empty=True, brands=brands(),
    ...
    return render_template('homepage/carts.html', discounttotal=discounttotal, subtotals=subtotals, brands=brands(),
                           categories=categories())
