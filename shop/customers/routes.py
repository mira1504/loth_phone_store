...
def update_account():
    ...
    if request.method == "POST":
        ...
        flash(f'Cập nhật thông tin thành công!', 'success')
        db.session.commit()
        return redirect(url_for('update_account'))
...
def change_password():
    ...
    if request.method == "POST":
        ...
        flash(f'Cập nhật mật khẩu thành công!', 'success')
        db.session.commit()
        return redirect(url_for('change_password'))
...
def customer_register():
    ...
    if form.validate_on_submit():
        ...
        try:
            ...
            flash(f'Xin chào {form.first_name.data} {form.last_name.data} .Cảm ơn đã đăng ký', 'success')
            db.session.commit()
        except:
